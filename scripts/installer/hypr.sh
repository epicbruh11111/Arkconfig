...
run_command "pacman -S --noconfirm swaync" "Install swaync notification daemon/notification center" "yes"
run_command "cp -r $BASE_DIR/configs/swaync /home/$SUDO_USER/.config/" "Copy swaync config" "yes" "no"
